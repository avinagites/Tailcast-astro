      ...
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-white  px-8 sm:px-8 md:px-20 lg:px-4">
            <span className="inline md:hidden">Cooperation</span>
            <span className="hidden md:inline">community webapp</span>
          </div>
        ...
        >
          ...
          Nitimi is a set of tools to create a public website, as well as an intranet to keep track of all your practicalities in one place.
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
